...
## Sessão 4 – 4 de junho de 2026

**Elementos presentes:** Bernardo Craveiro, Helder Silva

**Objetivo:**
Adicionar a biblioteca de designs guardados e permitir regressar ao customizer com o mesmo estado visual da personalização.

**Atividades realizadas:**

* Helder Silva: Implementação da biblioteca de designs guardados com persistência por utilizador;
* Helder Silva: Adição de ações para editar um design guardado e adicionar o mesmo design ao carrinho;
* Helder Silva: Implementação do draft persistido do customizer para restaurar imagem, posição, escala e rotação;
* Helder Silva: Atualização do fluxo do carrinho para permitir voltar à personalização sem perder o estado do design;
* Helder Silva: Simplificação da apresentação da biblioteca, removendo os detalhes técnicos e mantendo apenas a pré-visualização e as ações principais.

**Problemas:**

* Ao regressar do carrinho para a customização, o design perdia o estado anteriormente configurado.

**Solução:**

* Criação de um draft local do customizer e reutilização dos dados guardados para repor a imagem e os ajustes.

**Decisões:**

* Separar a biblioteca de designs do histórico de encomendas;
* Manter o estado do customizer localmente para permitir edição posterior sem repetir o trabalho;
* Dar prioridade às ações de editar e adicionar ao carrinho na biblioteca de designs.

---

## Sessão 5 – 8 de junho de 2026
